      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-md p-6 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.totalCanvases.toLocaleString()}</div>
            <div className="text-sm text-gray-600">Total Canvases</div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.totalArtists.toLocaleString()}</div>
        ...
        {featuredCanvases.length > 0 && (
          <div className="mb-12">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Featured Canvases</h2>
            </div>
