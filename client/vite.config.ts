...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Canvas Crafters',
        short_name: 'Canvas Crafters',
        description: 'The ultimate digital canvas platform for artists, designers, and creative teams. Draw, design, and collaborate in real-time.',
        theme_color: '#2563eb',
